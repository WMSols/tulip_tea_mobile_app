...
import 'package:tulip_tea_mobile_app/presentation/controllers/order_booker/shops/shops_controller.dart';
...
/// Order Booker shops screen with tabs for shop registration and my shops.
class OrderBookerShopsScreen extends StatefulWidget {
  const OrderBookerShopsScreen({super.key});

  @override
  State<OrderBookerShopsScreen> createState() => _OrderBookerShopsScreenState();
}

class _OrderBookerShopsScreenState extends State<OrderBookerShopsScreen>
