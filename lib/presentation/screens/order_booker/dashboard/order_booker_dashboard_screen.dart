...
import 'package:tulip_tea_mobile_app/core/widgets/features/order_booker/dashboard/assigned_routes_section.dart';
import 'package:tulip_tea_mobile_app/core/widgets/features/order_booker/dashboard/schedule_calendar_view.dart';
...
/// Order Booker dashboard screen showing wallet, routes, schedule, and transactions.
class OrderBookerDashboardScreen extends StatelessWidget {
  const OrderBookerDashboardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final c = Get.find<OrderBookerDashboardController>();
    return Scaffold(
